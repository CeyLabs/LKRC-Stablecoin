...
| --- | --- | --- | --- | --- |
| Governance Council | Strategic oversight, policy setting, emergency actions | Upgrade governance parameters, ratify new partners, authorize emergency circuit-breakers | Supermajority (≥ 70%, implemented as 7-of-10 multisig) for upgrades or partner onboarding, simple majority for routine policy updates | Multi-sig forum, weekly governance sync, incident bridge (Signal/Matrix) |
...
- Supermajority thresholds rely on a 7-of-10 (70%) governance multi-signature wallet implemented in the `GovernanceCouncil` smart contract.
